...
account_features_dataset = dataset[
    ["name", "screen_name", "default_profile", "geo_enabled", "protected", "verified", "statuses_count", "followers_count", "friends_count", "favourites_count",
     "listed_count"]]


account_features_dataset = account_features_dataset.astype({'name': 'string'})
account_features_dataset = account_features_dataset.astype({'screen_name': 'string'})

#print(account_features_dataset.info())  # shows dtype and non null values

account_features_dataset[['default_profile', 'geo_enabled', 'protected', 'verified']] = account_features_dataset[
    ['default_profile', 'geo_enabled', 'protected', 'verified']].fillna(value=0)
